...
class ModelTraining:
    def __init__(self, data_path, config_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key=self.config['comet-ml'],
            project_name="mlops-course",
            workspace="shaghayegh-matlabi"
        )
    ...
    def train_model(self):
        try:
            ...
            try:
                ...
                CustomException("Model training failed...", e)

            self.save_model_weights(model)

        except Exception as e:
            logger.error(str(e))
            CustomException("Error during model training process", e)
    ...
    def extract_weights(self, layer_name, model):
        try:
            ...
            logger.error(str(e))
            raise CustomException("Error during weight Extracting process", e)
